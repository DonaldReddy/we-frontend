...
export default function BookSkeleton() {
	return (
		<div className="flex flex-col  justify-center p-4 rounded-lg shadow-md bg-blue-50 max-w-[300px]  animated-background bg-gradient-to-r from-blue-200 via-blue-300 to-indigo-200">
